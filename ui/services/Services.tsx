...
export function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 justify-center p-5 mt-3 max-w-[600px] min-h-[200px] bg-[#ffffff] rounded-[20px] drop-shadow-md">
        {service === "coaching" || service === "groups" ? (
          <p id='coming-soon' className="text-blue-500 text-center text-xl">Coming soon!</p>
        ) : (
