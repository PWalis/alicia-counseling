        ...
        <div className="w-full sm:max-w-[45rem] flex justify-end items-center max-w-[5rem]">
          ...
          <motion.div
            ...
            className={clsx(
              ...
              menuIsOpen ? "-top-3 -right-7 place-content-center" : "hidden"
            )}
          >
            <nav
              className={clsx(
            ...
            >
              ...
              <div className=" lg1/2:hidden flex flex-col lg:justify-center gap-5 text-sm mt-6 text-pink-300">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <a href="https://maps.app.goo.gl/PmBFxvqFiDuWAWXW8" target="_blank" className="w-[300px] text-center">Private Entrance: 201 N. Trinity, Decatur, Texas 76234 </a>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="w-10 h-10">
                    <svg
